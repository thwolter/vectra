...
# docker-run.sh — Run the vecapi container
# Usage:
#   scripts/docker-run.sh [TAG] [HOST_PORT]
# Examples:
#   scripts/docker-run.sh                 # runs vecapi:latest on 8010 -> 8000
#   scripts/docker-run.sh vecapi:latest 9000
#
...
#   ENV_FILE=./.env.sandbox scripts/docker-run.sh
